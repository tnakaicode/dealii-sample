...
def create_3d_grid():
    ...
    vertices_1 = [[-1.5, 0.], [-0.5, 0.], [0.5, 0.], [1.5, 0.],              [-1.5, 1.5], [-0.5, 1.5], [0.5, 1.5], [1.5, 1.5],              [-1.5, 3.], [-0.5, 3.], [0.5, 3.], [1.5, 3.],              [-0.5, 3 + 0.5 * math.sqrt(3)],              [0.5, 3 + 0.5 * math.sqrt(3)],              [-0.75, 3 + 0.75 * math.sqrt(3)],              [0.75, 3 + 0.75 * math.sqrt(3)]]
...
get_ipython().run_cell_magic('html', '', '<img src="https://www.dealii.org/images/steps/developer/step-49.yuhan.8.png">')
...
get_ipython().run_cell_magic('html', '', '<img src="https://www.dealii.org/images/steps/developer/step-49.yuhan.9.png">')
...
get_ipython().run_cell_magic('html', '', '<img src="https://www.dealii.org/images/steps/developer/step-49.yuhan.11.png">')
